...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_json_path', type=str, default=r'F:\Workprojects\wireless_charging\back_corner_drop\json')
    parser.add_argument('--save_img_json_path', type=str, default=r'F:\Workprojects\wireless_charging\back_corner_drop\train_data')
