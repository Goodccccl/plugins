...
def parse_args():
    ...
    parser.add_argument('-m', dest='model_path', default=r"D:\TensorRT-8.6.1.6\bin\model.trt", help='TRT模型路径', type=str)
    parser.add_argument('-s', dest='image_size', required=False, help='图像尺寸，如336', type=int, default=452)
